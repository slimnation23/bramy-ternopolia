...
function s2(r2, i2) {
  const a4 = [], u3 = n2.reduce((e2, t2) => (e2[t2] = e2[t2] || [], e2), { processOptions: [r], validateOptions: [s] });
  function c4(e2) {
    const t2 = "object" == typeof e2 && e2.callSiteStack ? e2.callSiteStack : void 0, r3 = t2 ? void 0 : new Error(), n4 = o2.reduce((e3, t3) => (e3[t3] = /* @__PURE__ */ (function() {
    ...
    })(), e3), {}), s3 = /* @__PURE__ */ ((e3) => function(t3, r4, ...o3) {
      const n5 = "onError" === t3;
      let s4 = r4;
      for (let r5 = 0; r5 < e3[t3].length && (s4 = (0, e3[t3][r5])(s4, ...o3), !n5 || s4); r5++) ;
      return s4;
    })(u3), a5 = s3("processOptions", e2);
    s3("validateOptions", a5);
    const c5 = { options: a5, channels: n4, applyMiddleware: s3 };
    let l3;
    const h2 = n4.request.subscribe((e3) => {
      l3 = i2(e3, (o3, i3) => ((e4, o4, i4) => {
        let a6 = e4, u4 = o4;
        if (!a6) try {
          u4 = s3("onResponse", o4, i4);
        } catch (e5) {
          u4 = null, a6 = e5;
        }
        if (a6 = a6 && s3("onError", a6, i4), a6) {
          ...
          n4.error.publish(a6);
        } else u4 && n4.response.publish(u4);
      })(o3, i3, e3));
    });
    n4.abort.subscribe(() => {
      h2(), l3 && l3.abort();
    });
    const d3 = s3("onReturn", n4, c5);
    return d3 === n4 && n4.request.publish(c5), d3;
  }
  return c4.use = function(e2) {
  ...
  }, c4.clone = () => s2(a4, i2), r2.forEach(c4.use), c4;
}
var i;
var a2;
var u = c((function() {
  ...
  return i = function(r2) {
    ...
    for (var o3 = /* @__PURE__ */ Object.create(null), n4 = e2(r2).split("\n"), s3 = 0; s3 < n4.length; s3++) {
      var i2 = n4[s3], a4 = i2.indexOf(":"), u3 = e2(i2.slice(0, a4)).toLowerCase(), c4 = e2(i2.slice(a4 + 1));
      typeof o3[u3] > "u" ? o3[u3] = c4 : t2(o3[u3]) ? o3[u3].push(c4) : o3[u3] = [o3[u3], c4];
    }
    return o3;
  };
})());
...
var d = (e2, t2) => {
  const r2 = e2.options, o3 = e2.applyMiddleware("finalizeOptions", r2), n4 = {}, s3 = e2.applyMiddleware("interceptRequest", void 0, { adapter: l, context: e2 });
  if (s3) {
    const e3 = setTimeout(t2, 0, null, s3);
    return { abort: () => clearTimeout(e3) };
  }
  let i2 = new h();
  i2 instanceof c2 && "object" == typeof o3.fetch && i2.setInit(o3.fetch, o3.useAbortSignal ?? true);
  ...
  if (i2.onerror = (e3) => {
    ...
    d3 && (w(), n4.socket = setTimeout(() => y("ESOCKETTIMEDOUT"), d3.socket)), !p3 && i2 && 4 === i2.readyState && 0 !== i2.status && (function() {
      if (!(p3 || f3 || b)) {
        if (0 === i2.status) return void m(new Error("Unknown XHR error"));
  ...
  }, i2.open(o3.method, o3.url, true), i2.withCredentials = !!o3.withCredentials, a4 && i2.setRequestHeader) for (const e3 in a4) a4.hasOwnProperty(e3) && i2.setRequestHeader(e3, a4[e3]);
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-NDFFJH4H.js").then(function(n4) {
...
var eventSourcePolyfill = defer(() => import("./browser-LCXZ2HZT.js")).pipe(
