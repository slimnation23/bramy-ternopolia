...
const mapData = [
  {
    ...
    images: [
      bramyTheme.themeUrl + '/assets/images/img-1.webp',
      bramyTheme.themeUrl + '/assets/images/img-2.webp',
      bramyTheme.themeUrl + '/assets/images/img-3.webp',
    ],
  },
  {
    id: 2,
    ...
    images: [
      bramyTheme.themeUrl + '/assets/images/img-2.webp',
      bramyTheme.themeUrl + '/assets/images/img-3.webp',
      bramyTheme.themeUrl + '/assets/images/img-5.webp',
    ],
  },
  {
    id: 3,
    ...
    images: [
      bramyTheme.themeUrl + '/assets/images/img-5.webp',
      bramyTheme.themeUrl + '/assets/images/img-1.webp',
      bramyTheme.themeUrl + '/assets/images/img-4.webp',
    ],
  },
];
